...
// Define the plugin:
$PluginInfo['OccupyForum'] = array(
   'Name' => 'Occupy Forums',
   'Description' => 'Provides functionality to support usage by forum.occupy.net.',
   'Version' => '1.0',
...
//   'SettingsUrl' => '/plugin/example',
   ...
   'Author' => "Ed Knutson",
   'AuthorEmail' => 'knutsoned@gmail.com',
   'AuthorUrl' => 'http://www.vanillaforums.com'
);

class OccupyForumPlugin extends Gdn_Plugin {
   ...
   public function Base_Render_Before($Sender) {
      $Sender->AddCssFile($this->GetResource('design/forum.css', FALSE, FALSE));
